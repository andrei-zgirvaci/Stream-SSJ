function init_Rudder(){
	...
	canvas.style.left = parseInt($('#Throttle_var').css('width').replace('px', ''))*2 + parseInt($('#Throttle_var').css('border-right').replace('px', '')) + 14 - parseInt($('#Rudder_var').css('border-width').replace('px', '')) + "px";
